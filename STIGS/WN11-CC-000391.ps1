<#
.SYNOPSIS
    This PowerShell script configures the system to ensure the maximum size 
    of the Windows Application event log is at least 32768 KB (32 MB) in 
    accordance with Windows 11 STIG WN11-AU-000500.
